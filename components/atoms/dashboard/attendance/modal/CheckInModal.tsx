...
import { checkInModal, closeCheckInModal, selectedCheckInType, setSelectedCheckInType } from '@/app/lib/entities/attendance.entity';
...
export const CheckInModal = () => {
    ...
    return (
        <div>
            ...
            >
                <div>
                    <RadioOptionType options={options} selectedOption={selectedCheckIn} setSelectedOption={setSelectedCheckInType} />
