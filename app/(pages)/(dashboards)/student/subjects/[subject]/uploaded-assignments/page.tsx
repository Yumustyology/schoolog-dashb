      ...
      <div className="bg-white w-full p-6 mt-6 rounded-lg min-h-[826px] h-auto relative">
        ...
        <div className='flex flex-col gap-6 '>
          ...
          <div className='mt-[49px]'>
            <h2 className={cn('text-[#101828] text-[18px] mb-2', poppins_500.className)}> Your answers </h2>
            <p className={cn('text-[#475467] text-sm  ', poppins_400.className)}> Click the button below to upload assignment </p>
