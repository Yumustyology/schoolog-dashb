...
import { closeMoveModal, graduateModal, moveModal, selectedGraduateType, selectedMoveType, setSelectedGraduateType, setSelectedMoveType } from '@/app/lib/entities/student.entity';
...
export const MoveStudentModal = () => {
    ...
    return (
        <div>
            ...
            >
                <div>
                    <RadioOptionType options={options} selectedOption={selectedMove} setSelectedOption={setSelectedMoveType} />
                    ...
                    <div className='mt-8'>
                        ...
                        <DropdownMultiSelect options={classes} value={selectClass} onChange={setSelectClass} placeholder="Select classes..." />
                    </div>
                </div>
                <Button wide round className="h-12 mt-8" onClick={() => { handleMove }}>
                    {
                        selectedMove === 'promotion' ? 'Promotion'
                            : 'Demote'
                    }
                </Button>
            </Modal>
