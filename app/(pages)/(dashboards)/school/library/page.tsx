            ...
            <div className="flex justify-between items-center">
                ...
                <div className='flex gap-4'>
                    ...
                    <Button
                        ...
                        onClick={()=>{setOpenGiveOutBookModal(true)}}
                    >
                        {' '}
                        <ClockIcon />
                    ...
                    <AddBookModal isOpen={openAddBookModal} setIsOpen={setOpenAddBookModal}/>
                    <GiveOutBookModal isOpen={openGiveOutBookModal} setIsOpen={setOpenGiveOutBookModal}/>
                </div>
            </div>
