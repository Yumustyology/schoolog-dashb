  ...
  return (
    <div>
      ...
      <div className='mb-12 mt-6'>
        <h2 className={cn('text-xltext-gray1 mb-1', poppins_500.className)}>Timetable </h2>
        <p className={cn('text-sm text-gray3', poppins_400.className)}> Select the day and time for your subject </p>
      </div>
