...
import { closeAddTeacherMenu, closeAddTeamMenu, isAddTeacherMenuOpen, isAddTeamMenuOpen, openUploadTeacherModal } from '@/app/lib/entities/staff.entity'
import { closeAddStudentsMenu, openUploadStudentModal } from '@/app/lib/entities/student.entity'
...
export const AddTeamMenu = () => {
    ...
    const options = [
        ...
        },
        {
            ...
            click: () => { router.push('/school/non-teaching-staffs/add-new-team') }
        }
    ]
    return (
