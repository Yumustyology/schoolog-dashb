            ...
            {announcements.length === 0 ?
                (
                    <div className="flex flex-col items-center justify-center text-gray-500 py-12">
                        <Empty icon={<NoAnnouncementIcon/>} title='No annoucement yet' description='You have not yet created any announcement. Click the button below to create announcement' buttonText='+ Create Annoucement' />
                    </div>
                ...
                (
                    <div className="flex flex-col gap-4">
                        {announcements.map((announcement) => {
                            return (
                                <Announcement announcement={announcement}  type='school'/>
                            );
                        })
                        }
                    </div>
