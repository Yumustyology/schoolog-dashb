...
export const GraduateModal = () => {
  ...
  return (
    <div>
      <Modal isOpen={isOpen} onClose={closeGraduateModal} title="Graduate">
        <div>
          <RadioOptionType
            options={options}
            selectedOption={selectedGraduate}
            setSelectedOption={setSelectedGraduateType}
          />
      ...
      <ConfirmModal
        icon={<GraduateModalIcon />}
        title="Graduate 100 students"
        content="Are you sure you want to graduate these students? these students won’t be among active students again"
        btnText="Graduate"
