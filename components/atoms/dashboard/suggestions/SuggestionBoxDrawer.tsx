      ...
      >
        <div className="p-6 overflow-y-auto max-h-[calc(100vh-140px)]">
          <div className="">
            <Typography>
              <h2
                className={cn('text-xl text-gray1 mb-4', poppins_500.className)}
              >
              ...
              >
                ...
                massa. Nullam mi eget porttitor mattis. Turpis suspendisse sag
                ittis ultricies non at adipiscing. Id ac amet sit nisl vivamus.
                Leo ultricies ornare pulvinar netus at semper nulla. Egestas id
                ipsum orci viverra quam risus tempus semper nec. Nunc.
              </p>
            </Typography>
          </div>
        </div>
