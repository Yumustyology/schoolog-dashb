  ...
  return (
    <div>
      ...
      <div className='mb-12 mt-6'>
        <h2 className={cn('text-xltext-gray1 mb-1', poppins_500.className)}>Create Curriculum </h2>
        <p className={cn('text-sm text-gray3', poppins_400.className)}>Enter details of each topics in the curriculum  </p>
      </div>
      <div>
      ...
      {curriculumType === 'upload_xls' && (
        ...
        <div className=''>
          ...
          <div className='mx-auto mb-16 mt-8 text-center bg-primary bg-opacity-5 border border-primary rounded-xl border-opacity-15 w-full py-7 px-10'>
            ...
            <p className={cn('text-sm text-primary', poppins_400.className)}> Upload file </p>
