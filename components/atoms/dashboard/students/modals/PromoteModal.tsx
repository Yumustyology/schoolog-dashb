...
import {  closePromoteModal, graduateModal,promoteModal,selectedPromoteType, setSelectedPromoteType,  } from '@/app/lib/entities/student.entity';
...
import { GraduateModalIcon, PromoteModalIcon } from '@/components/atoms/icons/Icon2';
...
export const PromoteModal = () => {
    ...
    return (
        <div>
            ...
            >
                <div>
                    <RadioOptionType options={options} selectedOption={selectedPromote} setSelectedOption={setSelectedPromoteType} />
            ...
            <ConfirmModal icon={<PromoteModalIcon />} title='Promote 100 students' content='Are you sure you want to promote these classes? the students under these classes will be promoted to next class' btnText='Graduate' open={isGraduateSuccessModalOpen} close={()=>{setIsGraduateSuccessModalOpen(false)}}/>
        </div>
    )
}
