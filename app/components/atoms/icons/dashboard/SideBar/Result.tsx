...
function Result({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M15.8332 9.99935V4.99935C15.8332 3.15768 15.8332 1.66602 12.4998 1.66602H7.49984C4.1665 1.66602 4.1665 3.15768 4.1665 4.99935V9.99935"
        stroke={color}
        strokeWidth="1.5"
        strokeMiterlimit="10"
        strokeLinecap="round"
