...
export const StudentFilterSlider = ({filtertype}: {filtertype: string}) => {
    return (
        <div className="w-full max-w-md mx-auto py-5">
            <p className={cn('text-base text-gray1 mb-3', poppins_500.className)}> {filtertype }</p>
            <ReactSlider
                ...
                renderThumb={(props, state) => (
                    <div {...props} className="relative w-6 h-6 flex items-center justify-center cursor-pointer">
