...
import { closeUploadTeacherModal, isUploadTeachersOpen } from '@/app/lib/entities/staff.entity'



export const UploadTeamsModal = () => {
    ...
    return (
        ...
        >
            ...
            <Button wide round className="h-12 mt-7" onClick={closeUploadTeacherModal}>
                Upload teachers
            </Button>
        </Modal>
