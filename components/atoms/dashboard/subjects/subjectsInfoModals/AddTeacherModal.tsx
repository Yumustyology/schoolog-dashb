...
import { addTeacherModal, changeAssignedTeacherModal, closeAddTeacherModal, closeChangeTeacherModal } from '@/app/lib/entities/subject.entity';
    ...
    return (
        ...
        >
            <div className='max-h-80 overflow-y-scroll px-2'>
                ...
                <div className='mt-8 '>
                    <h3 className={cn('text-base text-gray mb-6', poppins_500.className)}>Teachers </h3>
