...
import {
  selectedActivityPreference,
  setSelectedActivityPreference,
} from '@/app/lib/entities/activity.entity';
    ...
    <div>
      ...
      <div>
        <RadioOptionType
          ...
          setSelectedOption={setSelectedActivityPreference}
        />
      </div>
