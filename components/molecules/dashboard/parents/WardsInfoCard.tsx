                ...
                numberOfWards <= 1
                    ? (
                        ...
                        <div>
                            ...
                            <SingleInfo leftText='Secondary Gurdian' leftValue='Muhammad Adeolu' rightText='Secondary guardian number' rightValue='0806932341' />
                            ...
                            <div className='flex gap-3 items-center mt-4'>
                                ...
                                <Button wide round flat className="h-[45px] border border-primary"  >
                                    ...
                                    <p className={cn("ml-2 text-primary text-base", poppins_500.className)}>View Details</p>
                                </Button>
                    ...
                    : (
                        ...
                        <div className='flex flex-col gap-4'>
                            <h4 className={cn('text-lg text-black1', poppins_500.className)}>Students </h4>
                            <SingleWardCard />
                            <SingleWardCard />
                            <SingleWardCard />
        ...
        <div className='bg-gray11 rounded-full p-3.5'>
            <div className="flex gap-5">
                ...
                <div className='flex justify-between items-center w-full'>
                    ...
                    <Button round className={cn('text-gray6 bg-[#EBEBEB] text-sm px-3 py-2 ', poppins_400.className)}>
                        View details
                    </Button>
