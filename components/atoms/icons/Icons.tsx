  ...
  return (
    ...
    >
      ...
      <g mask="url(#mask0_3960_192549)">
        <path
          d="M69.1384 51.2424C69.0101 51.2241 68.8817 51.2241 68.7534 51.2424C65.9117 51.1507 63.6567 48.8224 63.6567 45.9624C63.6567 43.0474 66.0217 40.6641 68.9551 40.6641C71.8701 40.6641 74.2534 43.0291 74.2534 45.9624C74.2351 48.8224 71.9801 51.1507 69.1384 51.2424Z"
          fill={theme.primary}
        />
        <path
          d="M75.115 63.9468C73.0617 65.3218 70.1833 65.8352 67.525 65.4868C68.2217 63.9835 68.5883 62.3152 68.6067 60.5552C68.6067 58.7218 68.2033 56.9802 67.4333 55.4585C70.1467 55.0918 73.025 55.6052 75.0967 56.9802C77.9934 58.8868 77.9934 62.0218 75.115 63.9468Z"
          fill={theme.primary}
        />
        <path
          d="M48.8066 51.2424C48.935 51.2241 49.0633 51.2241 49.1916 51.2424C52.0333 51.1507 54.2883 48.8224 54.2883 45.9624C54.2883 43.0291 51.9233 40.6641 48.99 40.6641C46.075 40.6641 43.71 43.0291 43.71 45.9624C43.71 48.8224 45.965 51.1507 48.8066 51.2424Z"
          fill={theme.primary}
        />
        <path
          d="M49.0083 60.5555C49.0083 62.3338 49.3933 64.0205 50.09 65.5422C47.505 65.8172 44.81 65.2672 42.83 63.9655C39.9333 62.0405 39.9333 58.9055 42.83 56.9805C44.7916 55.6605 47.56 55.1288 50.1633 55.4222C49.4116 56.9622 49.0083 58.7038 49.0083 60.5555Z"
          fill={theme.primary}
        />
        <path
          d="M59.22 66.095C59.0734 66.0767 58.9084 66.0767 58.7434 66.095C55.37 65.985 52.675 63.2167 52.675 59.8067C52.6934 56.3233 55.4984 53.5 59 53.5C62.4834 53.5 65.3067 56.3233 65.3067 59.8067C65.2884 63.2167 62.6117 65.985 59.22 66.095Z"
          fill={theme.primary}
        />
        <path
          d="M53.2616 69.8937C50.4932 71.7454 50.4932 74.7888 53.2616 76.6221C56.4149 78.7304 61.5849 78.7304 64.7382 76.6221C67.5066 74.7704 67.5066 71.7271 64.7382 69.8937C61.6032 67.7854 56.4332 67.7854 53.2616 69.8937Z"
          fill={theme.primary}
        />
      </g>
    </svg>
...
export const TermSessionSideBarIcon = () => (
  <svg width="118" height="118" viewBox="0 0 118 118" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M68.1667 40.667H49.8334C44.7584 40.667 43.4167 42.0087 43.4167 47.0837V54.5003H74.5834V47.0837C74.5834 42.0087 73.2417 40.667 68.1667 40.667Z" fill="#21B55A"/>
    <path d="M74.5834 57.2503H43.4167V70.917C43.4167 75.992 44.7584 77.3337 49.8334 77.3337H68.1667C73.2417 77.3337 74.5834 75.992 74.5834 70.917V57.2503ZM56.4167 72.1253H51.6667C50.9151 72.1253 50.2917 71.502 50.2917 70.7503C50.2917 69.9987 50.9151 69.3753 51.6667 69.3753H56.4167C57.1684 69.3753 57.7917 69.9987 57.7917 70.7503C57.7917 71.502 57.1684 72.1253 56.4167 72.1253ZM66.3334 65.167H51.6667C50.9151 65.167 50.2917 64.5437 50.2917 63.792C50.2917 63.0403 50.9151 62.417 51.6667 62.417H66.3334C67.0851 62.417 67.7084 63.0403 67.7084 63.792C67.7084 64.5437 67.0851 65.167 66.3334 65.167Z" fill="#21B55A"/>
    <path d="M49.375 47.542C48.6233 47.542 48 46.9187 48 46.167V41.417C48 40.6653 48.6233 40.042 49.375 40.042C50.1267 40.042 50.75 40.6653 50.75 41.417V46.167C50.75 46.9187 50.1267 47.542 49.375 47.542Z" fill="#21B55A"/>
    <path d="M68.625 47.542C67.8733 47.542 67.25 46.9187 67.25 46.167V41.417C67.25 40.6653 67.8733 40.042 68.625 40.042C69.3767 40.042 70 40.6653 70 41.417V46.167C70 46.9187 69.3767 47.542 68.625 47.542Z" fill="#21B55A"/>
  </svg>
);


export const TermSessionIcon = () => (
  <svg width="118" height="118" viewBox="0 0 118 118" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="59" cy="59" r="59" fill="#21B55A" fillOpacity="0.06"/>
    <circle cx="59.0001" cy="59.2933" r="35.8997" fill="#E9F8EF"/>
    <circle cx="59" cy="59.2937" r="39.9814" fill="#E9F8EF" stroke="white" strokeWidth="2.22634"/>
    <mask id="mask0_term_session" maskUnits="userSpaceOnUse" x="20" y="20" width="78" height="78">
      <circle cx="59.0003" cy="59.293" r="38.6827" fill="white"/>
    </mask>
    <g mask="url(#mask0_term_session)">
      <path d="M68.1667 40.667H49.8334C44.7584 40.667 43.4167 42.0087 43.4167 47.0837V54.5003H74.5834V47.0837C74.5834 42.0087 73.2417 40.667 68.1667 40.667Z" fill="#21B55A"/>
      <path d="M74.5834 57.2503H43.4167V70.917C43.4167 75.992 44.7584 77.3337 49.8334 77.3337H68.1667C73.2417 77.3337 74.5834 75.992 74.5834 70.917V57.2503ZM56.4167 72.1253H51.6667C50.9151 72.1253 50.2917 71.502 50.2917 70.7503C50.2917 69.9987 50.9151 69.3753 51.6667 69.3753H56.4167C57.1684 69.3753 57.7917 69.9987 57.7917 70.7503C57.7917 71.502 57.1684 72.1253 56.4167 72.1253ZM66.3334 65.167H51.6667C50.9151 65.167 50.2917 64.5437 50.2917 63.792C50.2917 63.0403 50.9151 62.417 51.6667 62.417H66.3334C67.0851 62.417 67.7084 63.0403 67.7084 63.792C67.7084 64.5437 67.0851 65.167 66.3334 65.167Z" fill="#21B55A"/>
      <path d="M49.375 47.542C48.6233 47.542 48 46.9187 48 46.167V41.417C48 40.6653 48.6233 40.042 49.375 40.042C50.1267 40.042 50.75 40.6653 50.75 41.417V46.167C50.75 46.9187 50.1267 47.542 49.375 47.542Z" fill="#21B55A"/>
      <path d="M68.625 47.542C67.8733 47.542 67.25 46.9187 67.25 46.167V41.417C67.25 40.6653 67.8733 40.042 68.625 40.042C69.3767 40.042 70 40.6653 70 41.417V46.167C70 46.9187 69.3767 47.542 68.625 47.542Z" fill="#21B55A"/>
