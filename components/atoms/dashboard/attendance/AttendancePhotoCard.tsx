  ...
  return (
    <div className="bg-[#FAFAFA] border border-gray4 text-center flex flex-col gap-6 p-6">
      ...
      <div className="flex flex-col gap-2">
        <h4 className={cn('text-black text-xl', poppins_600.className)}>
          Muhammad Jamiu
        </h4>
        {type === 'teacher' ? (
          <p className={cn('text-gray6 text-base', poppins_400.className)}>
            Mathmatics / Assigned to SSS1
          </p>
        ) : (
          <p className={cn('text-gray6 text-base', poppins_400.className)}>
            SS1 / jimohjamiu2000@gmail.com
          </p>
        )}
      </div>
    </div>
