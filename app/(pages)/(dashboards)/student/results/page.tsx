  ...
  return (
    <div>
      ...
      <section>
        <ResultLists />
        {isModalOpen && (
          <FormModal isOpen={true} onClose={onClose} title="Check result">
            <div>
              <div>
                ...
                <p
                  className={cn('text-sm text-gray mt-1', Inter_400.className)}
                >
                  Input the 5 unique code issued to your parents after
                  purchasing the report card pass
                </p>
              </div>

              <div className="mt-12">
                <Label className="text-gray1 text-[16px] mb-2">
                  {' '}
                  Report card code{' '}
                </Label>
                <Input
