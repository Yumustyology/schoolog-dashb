            ...
            <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild>
                    <Button
                        ...
                        role="combobox"
                        aria-expanded={open}
                        className={cn("w-full justify-between h-14 rounded-lg border border-gray2 text-base text-gray3 p-4", className)}
                    >
                ...
                <PopoverContent className={cn('w-full p-0 rounded-lg', className)}>
                    <Command className="px-3 border-white">
                        <div
                         ...
                         className="w-full h-9 text-gray-700 bg-gray-100 border border-gray-300 rounded-full my-2 bg-[#F9FAFB]"
                        >
