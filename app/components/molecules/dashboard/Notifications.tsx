                ...
                {notifications.length > 0 ? (
                    ...
                    <div className="flex w-full h-screen">
                        <div className='flex flex-col justify-center items-center text-center mx-auto'>
                            ...
                            <NotificationBigIcon />
                            <h1 className={cn('mt-8 mb-3 text-xl text-gray1',  Inter_600.className)}>No notification</h1>
                            <p className={cn('text-sm text-gray',  Inter_500.className)}>You will be notified here about all your activities on the app</p>
                        </div>
                    </div>
                )}
            </DrawerSide>
