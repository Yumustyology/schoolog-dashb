  ...
  return (
    <div key={subject.subject} className="flex flex-col gap-4 min-w-[300px]">
      <Link href='/student/subjects/1234'>
        <Image className="w-full" src={subject.textbookImg} alt={subject.subject} />
      </Link>
      <div className="flex flex-col gap-3">
       <Link href='/student/subjects/1234'>
        <h3
          className={cn('text-base text-gray1 font-semibold', poppins_500.className)}
        >
          {subject.subject}
        </h3></Link>
        ...
        <div className={cn('flex items-center gap-2 text-gray6', poppins_400.className)}>
          ...
          <p className="text-sm">
            <span className="font-semibold">{subject.number_of_topics_covered} </span>
