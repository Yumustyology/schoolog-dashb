...
import { checkOutModal, closeCheckOutModal, selectedCheckOutType, setSelectedCheckOutType } from '@/app/lib/entities/attendance.entity';
...
export const CheckOutModal = () => {
    ...
    return (
        <div>
            ...
            >
                <div>
                    <RadioOptionType options={options} selectedOption={selectedCheckOut} setSelectedOption={setSelectedCheckOutType} />
