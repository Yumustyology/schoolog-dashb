...
import { Inter_400, Inter_500, Inter_800, poppins_600 } from "@/app/lib/config/font.config";
                        ...
                        {items.map((item) => (
                            <SidebarMenuItem key={item.title} >
                                <SidebarMenuButton className="py-5 rounded-full" asChild>
                                    ...
                                    >
                                        {item.icon}
                                        <span className="text-sm">{item.title}</span> {/* Hide title on small screens */}
                                    </a>
                                </SidebarMenuButton>
                            </SidebarMenuItem>
                        ))}
...
export function SwitchDemo() {
    return (
        <div className="flex items-center justify-center space-x-2">
            <Label htmlFor="darkMode" className={cn("text-sm text-[#4f4f4f]", Inter_500.className)}>Dark mode </Label>
