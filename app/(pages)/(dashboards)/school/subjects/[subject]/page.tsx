                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div>
                        <Button round className="h-[48px]  py-3 px-8 flex gap-2">
                            ...
                            <span className={cn('text-base ', Inter_500.className)}> Edit Curriculum </span>
                        </Button>

                        <Button round  flat className="h-[48px] border border-primary ml-4  py-3 px-8 flex gap-2">
                            {' '}
                            <UploadIcon />
                            <span className={cn('text-base ', Inter_500.className)}>Upload Resources </span>
                        </Button>
                    </div>
