...
import { NoAttendanceIcon, NoStudentIcon } from '@/components/atoms/icons/Icons';
        ...
        <div>
            {attendanceList.length === 0 ? (
                <div className="flex flex-col items-center justify-center text-gray-500 py-12">
                    <Empty icon={<NoAttendanceIcon />} title='No attendance logged' description='You have not yet log any attendance. Click checkin or checkout buttons to log attendance'/>
                </div>
            ) : (
