...
type OverAllBestProps = React.ComponentProps<typeof Card>;

export function OverAllBestSubjectsList({
  className,
  ...props
}: OverAllBestProps) {
  return (
    ...
    >
      <CardHeader>
        ...
        >
          <span> Overall best subjects </span>
          <span
            className={cn(
      ...
      <CardContent className="grid gap-4 mt-0 max-h-[300px] overflow-auto sidebar-scroll">
        <div>
