    ...
    onSubmit: async (values: FormData): Promise<void> => {
      ...
      try {
        ...
        if (
          resp &&
          resp.data &&
          resp.data?.message === 'Password set successfully'
        ) {
          ...
          replaceProfileState({
            slg_id: resp.data.data?.slg_id || '',
            school_id: resp.data.data?.school_id || '',
            slug_id: resp.data.data?.slug_id || '',
            audience: resp.data.data?.audience || '',
            slug: resp.data.data?.slug || '',
            school_slug_id: resp.data.data?.school_slug_id || '',
