  ...
  return (
    <div className="bg-white py-6 h-[390px] pb-10 px-6 rounded-md col-span-2 border-none">
      <div className=" flex justify-between items-center">
        <div className="flex items-center gap-3">
          <div>
            ...
            <p
              className={cn('text-sm text-gray3 mt-1.5', poppins_400.className)}
            >
              Father
            </p>
          </div>
      ...
      <SingleInfo
        leftText="Students"
        leftValue="1"
        rightText="Secondary Guardian"
        rightValue="Muhammad Jamiu"
      />
      <SingleInfo
        leftText="email"
        leftValue="jimohjamiu2000@gmail.com"
        rightText="Guardian contact"
        rightValue="08065076959"
      />
      ...
      <div className=" mt-5">
        <Button
          ...
          onClick={openSuspendStudentModal}
        >
