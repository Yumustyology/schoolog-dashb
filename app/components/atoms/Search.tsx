    ...
    return (
        ...
        <div className='flex justify-start items-center gap-3 bg-[#F9FAFB] rounded-full py-2 px-4 w-full border border-gray4'>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M22 22L20 20" stroke="#828282" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>


            <input type='search' placeholder={placeholderName} className='bg-transparent outline-none  text-gray1 text-sm w-full' />
        </div>
    )
}
