...
import { NoParentAddedIcon, NoSuggestionIcon } from '@/components/atoms/icons/Icons';
                    ...
                    {suggestions.length === 0 ?
                        (
                            <div className="flex flex-col items-center justify-center text-gray-500 py-12">
                                <Empty icon={<NoSuggestionIcon />} title='No suggestion yet' description='You have not yet received any suggestion. suggestion made by students, parents nd teachers will be seen here ' />
                            </div>
                        ...
                        : (
                            <div className="grid grid-cols-3 gap-6 mt-4">
                                ...
                                {suggestions.map((suggestion, index) => {
                                    return (
                                        <SuggestionBox key={suggestion.id} suggestion={suggestion} type='Admin' />
                                    );
                                })}
                            </div>
