...
import { closeSuspendStudentModal, isSuspendStudentModalOpen } from '@/app/lib/entities/student.entity';
...
export const SuspendStudentModal = () => {
    ...
    const suspendStudentModalOpen = useEntity(isSuspendStudentModalOpen)

    return (
        <div>
            <Modal
                isOpen={suspendStudentModalOpen}
                onClose={closeSuspendStudentModal}
                title="Suspend"
            >
                <p className={cn('text-base text-center text-black1 mb-6', poppins_400.className)}>Let the student and guardian know the reason of the suspension</p>
