...
const SecuritySettings = () => {
  return (
    <div>
        ...
        <div>
            <h2 className={cn(`mb-2 text-base text-[#101828]`,Inter_600.className)}>Change password</h2>
          <p className={cn('text-[#475467] text-sm',Inter_400.className)}>Change your password to enhance security and protect your account from unauthorized individual</p>
        </div>
        <div  className='flex-shrink-0 h-[42px] w-[42px] flex items-center justify-center bg-[#21B55A1F] rounded-full'>
          ...
          <div>
            <h2 className={cn(`mb-2 text-base text-[#101828]`,Inter_600.className)}>Active sessions</h2>
          <p className={cn('text-[#475467] text-sm',Inter_400.className)}>End all session to logout from all devices ensuring that your account is only accessible from your current session</p>
          </div>
          <div className='flex-shrink-0 h-[42px] w-[42px] flex items-center justify-center bg-[#21B55A1F] rounded-full'>
          <LockIcon />
        </div>
