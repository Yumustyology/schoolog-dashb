...
import { closeSuspendTeacherModal, closeTerminateTeacherModal, isSuspendTeacherModalOpen, isTerminateTeacherModalOpen } from '@/app/lib/entities/staff.entity';
    ...
    return (
        <div>
            <Modal
                ...
                title="Terminate"
            >
                <p className={cn('text-base text-center text-black1 mb-6', poppins_400.className)}>Let the teacher know the reason of the termination</p>
