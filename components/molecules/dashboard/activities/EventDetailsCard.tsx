...
import { Inter_500, poppins_400, poppins_500 } from '@/app/lib/config/font.config'
...
import { DeleteIcon, DeleteModalIcon, EditIcon, GraduateIcon, OptionIcon, PromoteIcon, SuspendIcon } from '@/components/atoms/icons/Icons'
...
export const EventDetailCard = () => {
  return (
    <div className='bg-white py-6 h-[390px] pb-10 px-6 rounded-md col-span-2 border-none'>
      ...
      <SingleInfo leftText='Category' leftValue='Activity' rightText='Total registered' rightValue='82' />
      <SingleInfo leftText='Date' leftValue='March 15, 2025   ' rightText='Created on' rightValue='9/6/2025' />
      <SingleInfo leftText='Location' leftValue='Unilorin Zoo, Ilorin, Kwara.' rightText='Price tag' rightValue='free' />
      ...
      <div className='flex justify-between items-center mt-4'>
        ...
        <Button round className="h-[45px]  py-3 px-8 flex gap-2 flex-1 bg-r bg-opacity-10 w-full">
          {' '}
          <DeleteIcon/>
