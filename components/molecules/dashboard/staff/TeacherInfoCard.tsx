...
const menuItems = [
  { label: "Suspend", onClick: ()=> {openSuspendTeacherModal; console.log('clicked')}, icon: <SuspendIcon /> },
  { label: "Terminated", onClick: () => {openTerminateTeacherModal}, icon: <CancelIcon />, danger: true },
]
...
export const TeacherInfoCard = () => {
  return (
    <div className='bg-white py-6 h-[390px] pb-10 px-6 rounded-md col-span-2 border-none'>
      ...
      <SingleInfo leftText='Teacher ID' leftValue='172928739HD' rightText='Date of birth' rightValue='March 15, 2010' />
      <SingleInfo leftText='Assigned class' leftValue='SS1' rightText='Role' rightValue='Head of mathematics' />
