...
import Locked from '@/app/components/atoms/dashboard/subjects/Locked';
          ...
          <CardBody className="w-full flex justify-between items-center gap-3 p-3">
            ...
            >
              ...
              >
                ...
                <p className='text-gray3'>{assignment.no_of_questions} Questions</p>
              </Typography>
            </Typography>
                ...
                assignment.mode === 'locked'
                  ...
                  : assignment.mode === 'view'
                    ...
                    : assignment.mode === 'active'
                      ? (<div>
                        <p className={cn('text-primary text-[24px]', poppins_600.className)}> {assignment.no_of_questions_answered} <span className={cn('text-gray text-xl', poppins_400.className)}> / {assignment.no_of_questions} </span> </p>
                      </div>
                      )
                      : <Locked />
              }
