...
import {
  closeEditStaffPermissionModal,
  isEditStaffPermissionOpen,
    ...
    >
      <div className="max-h-80 overflow-y-scroll px-2">
        <div className="">
          ...
          <Button round className="p-2 bg-[#21B55A1F] my-3">
          ...
          <form action="" method="post" className="flex flex-col gap-4">
            <h6
              className={cn(
                'text-sm text-gray1 mt-8 mb-2',
                Inter_400.className
              )}
            >
              {' '}
              Select actions this role can access{' '}
            </h6>
            <PermissionToggle
            ...
            />
            <PermissionToggle
              permissionID="accessStuidentsDetails"
      ...
      <div className="flex items-center justify-between gap-4">
        <Button
          ...
          flat
          round
          className="h-12 mt-7 text-primary border border-primary"
          onClick={closeEditStaffPermissionModal}
        >
          Cancel
        </Button>
