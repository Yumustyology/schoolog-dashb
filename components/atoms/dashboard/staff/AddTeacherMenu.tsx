...
import { closeAddTeacherMenu, isAddTeacherMenuOpen, openUploadTeacherModal } from '@/app/lib/entities/staff.entity'
...
export const AddTeacherMenu = () => {
    ...
    const options = [
        ...
        },
        {
            ...
            click: () => { router.push('/school/teaching-staffs/add-new-teacher') }
        }
    ]
    return (
