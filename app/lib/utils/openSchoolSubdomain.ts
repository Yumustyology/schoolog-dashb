type SchoolIdentifiable = { slug?: string | null; name?: string | null; tenantDomain?: string | null };
...
export const buildSchoolSubdomainUrl = (school: SchoolIdentifiable, opts?: { usePath?: string }) => {
  ...
  const safeId = school?.tenantDomain || identifier.toLowerCase().replace(/[^a-z0-9-]/g, '');
