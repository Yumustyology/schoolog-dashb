  ...
  return (
    <div className="bg-white p-6 my-8 rounded-2xl flex justify-between">
      ...
      <SubjectModal
        type="delete"
        title="Delete book"
        content="Are you sure you want to delete this book? this book can’t be recovered"
      ...
      <SubjectModal
        type="archive"
        title="Archive book"
        content="Are you sure you want to archive this book? it won’t be visible to students and teachers again"
      ...
      <SubjectModal
        type="unarchive"
        title="Post book"
        content="Are you sure you want to post this book? This will make it visible to students and teachers"
