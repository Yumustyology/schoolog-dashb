...
import { closeUploadStudentModal, isUploadStudentsOpen } from '@/app/lib/entities/student.entity'
...
export const UploadStudentsModal = () => {
    ...
    return (
        ...
        >
            ...
            <Button wide round className="h-12 mt-7" onClick={closeUploadStudentModal}>
                Upload Students
            </Button>
        </Modal>
