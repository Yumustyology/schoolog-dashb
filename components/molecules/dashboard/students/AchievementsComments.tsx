...
const Achievements = () => {
  return (
    <div className="flex flex-col gap-6">
        ...
        achievements.map((achievement) => (
          <div className="bg-[#FCFCFC] rounded-md p-3 border border-gray4">
            <div className="flex justify-between items-center w-full">
              <div>
                <h3
                  className={cn('text-sm text-black1 mb-1', poppins_500.className)}
                >
                  {achievement.title}
                </h3>
      ...
      <Button wide className=" bg-gray11 text-center py-2.5 text-gray6"> See all </Button>
    </div>
  )
}
...
const Comments = () => {
  return (
    <div className='flex flex-col gap-4'>
      <p className='flex-1 leading-relaxed'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur consequuntur excepturi necessitatibus iusto sunt eaque dolor molestiae, dolores modi, quis autem nostrum placeat ipsum iure consectetur cumque molestias ut eius!</p>
      <p className='flex-1 leading-relaxed'> Lorem ipsum dolor sit amet consectetur adipisicing elit. Pariatur consequuntur excepturi necessitatibus iusto sunt eaque dolor molestiae, dolores modi, quis autem nostrum placeat ipsum iure consectetur cumque molestias ut eius!</p>
      <Button wide className="mt-auto bg-gray11 text-center py-2.5 text-gray6"> <EditIcon/> <span> Edit </span> </Button>
    </div>
  )
}
